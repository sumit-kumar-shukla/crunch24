...
if($('#timer-countdown').length>0){$('#timer-countdown').countdown({from:1800,to:0,movingUnit:1000,timerEnd:undefined,outputPattern:'$minute  min : $second secs',autostart:true});}
